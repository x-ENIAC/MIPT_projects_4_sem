...
class Button : public View_object {
  public:
	...
	Button(Button_delegate* par_delegate, const Point par_point, const Colour par_button_color,
				const double par_width, const double par_height, 
				const char text_on_button[] = TEXT_SPACE, const Colour par_text_color = BLACK,
